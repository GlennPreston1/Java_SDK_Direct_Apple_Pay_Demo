...
/**
 * Countries/territories with two letter ISO-3166 codes.
 */
public enum CountryCode {
	...
	BM("BM"), // Bermuda
	BT("BT"), // Bhutan
	BO("BO"), // Bolivia (Plurinational State of Bolivia)
	...
	KM("KM"), // Comoros
	CG("CG"), // Congo
	CD("CD"), // Congo (Democratic Republic of the Congo)
	CK("CK"), // Cook Islands
	CR("CR"), // Costa Rica
	CI("CI"), // Côte d'Ivoire
	HR("HR"), // Croatia
	...
	PK("PK"), // Pakistan
	PW("PW"), // Palau
	PS("PS"), // Palestine (State of Palestine)
	PA("PA"), // Panama
