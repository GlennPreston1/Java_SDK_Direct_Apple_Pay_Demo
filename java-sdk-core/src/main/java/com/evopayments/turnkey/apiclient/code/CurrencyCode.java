...
public enum CurrencyCode {
	...
	AUD("AUD"), AWG("AWG"), // Aruban Florin (ARUBA)
	...
	EUR("EUR"), FIM("FIM"), // Markka (FINLAND, ÅLAND ISLANDS)
	...
	// SAINT-BARTHÉLEMY)
	FRF("FRF"), GBP("GBP"), // Pound Sterling (UNITED KINGDOM, GUERNSEY, ISLE OF MAN, JERSEY)
	...
	RUR("RUR"), RWF("RWF"), // Rwanda Franc (RWANDA)
	...
	USD("USD"), USN("USN"), // US Dollar (Next day) (UNITED STATES)
	...
	XAF("XAF"), XAG("XAG"), // Silver (ZZ11_Silver)
	...
	XCD("XCD"), XDR("XDR"), // SDR (Special Drawing Right) (INTERNATIONAL MONETARY FUND (IMF))
	...
	// SENEGAL, TOGO)
	XOF("XOF"), XPD("XPD"), // Palladium (ZZ09_Palladium)
